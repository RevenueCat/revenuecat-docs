...
[block:parameters]
{
  "data": {
    ...
    "15-3": "Can be `NULL` if the price is unknown or if it is a product change event, and `0` for free trials.  \n  \nCan be negative for refunds.",
    "16-0": "`currency`",
    "16-1": "String",
    ...
    "17-3": "Can be `NULL` if the price is unknown or if it is a product change event, and `0` for free trials.  \n  \nCan be negative for refunds.",
    "18-0": "`tax_percentage`",
    "18-1": "Double",
