...
This close button will automatically take the color of your app's tint color. You can also override it by using `PaywallView(...).tintColor(Color.red)`, for example.
