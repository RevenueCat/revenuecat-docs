...
updatedAt: "2019-03-18T16:45:36.516Z"
---
...
[/block]
After you've set up the *Purchase* SDK to send attribution data from AppsFlyer to RevenueCat, you can "turn on" the integration and configure the event tokens from the RevenueCat dashboard.
