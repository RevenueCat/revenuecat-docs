...
hidden: false
metadata: 
  title: "Slack in-app purchase notifications | RevenueCat"
  ...
  image: 
    ...
    4: "#fbabaf"
createdAt: {}
updatedAt: "2020-05-11T15:26:45.649Z"
---
[block:callout]
{
  "type": "success",
  "body": "The Slack integration is only available on [paid](https://www.revenuecat.com/pricing) plans."
}
[/block]
