...
metadata: 
  ...
  description: "This document contains a checklist of things to consider before launching your app to production."
  image: 
    0: "https://files.readme.io/ac9fb34-Reddit__E.jpg"
    1: "Reddit – E.jpg"
    2: 1200
    3: 630
    4: "#fbabaf"
createdAt: {}
updatedAt: "2020-08-13T14:36:19.856Z"
---
...
[block:parameters]
{
  "data": {
    ...
    "0-1": "✅",
    "0-2": "✅",
    "0-0": "If you're setting your own user identifiers, make sure they are all being set as expected and you've [followed our tips](doc:user-ids#section-tips-for-setting-app-user-ids) - double check for hardcoded strings!"
  },
  "cols": 3,
  "rows": 1
}
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "iOS",
    "0-0": "Include [disclosure of auto-renewing subscription details](https://www.revenuecat.com/blog/apple-will-reject-your-subscription-app-if-you-dont-include-this-disclosure) in your app description.",
    "0-1": "✅",
    "h-2": "Android"
  },
  "cols": 3,
