...
metadata: 
  ...
  image: 
    0: "https://files.readme.io/9d8b8e1-OG_image.png"
    1: "OG image.png"
    2: 1200
    3: 627
    4: "#e9acb0"
createdAt: {}
updatedAt: "2021-06-21T15:54:12.625Z"
---
# What is RevenueCat?
...
{
  "type": "info",
  "body": "The latest version of react-native-purchases compatible with expo-in-app-purchases in observer mode is 3.3.2, since Expo hasn't upgraded to BillingClient version 3 yet ([GitHub issue](https://github.com/expo/expo/issues/12193) for reference)."
}
[/block]
# Next Steps
