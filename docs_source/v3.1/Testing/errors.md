...
metadata: 
  ...
  image: 
    0: "https://files.readme.io/901fe9c-OG_image.png"
    1: "OG image.png"
    2: 1200
    3: 627
    4: "#e9acb0"
createdAt: {}
updatedAt: "2021-05-26T19:34:21.384Z"
---
[block:callout]
{
  "type": "success",
...
If this error happens during the purchase flow, make sure your [Play Store Credentials](doc:creating-play-service-credentials) and/lor [App Store Shared Secret](doc:itunesconnect-app-specific-shared-secret) are configured correctly in the RevenueCat dashboard.
_______________________________________________________________________________
...
- Apple server is down (more common in sandbox then production)
...
####😿 `CONFIGURATION_ERROR`
**Problem:**
This error indicates that something is incorrect with your setup in the RevenueCat dashboard.

The problems that will trigger this on Android:
- Invalid Android package name in the RevenueCat dashboard

The problems that will trigger this on Android and iOS:
...
**Resolution:**
The user will either need to log in as the App User Id that already owns the receipt or [restore purchases](doc:getting-started#restoring-purchases) to re-sync the receipt with their current account.
_______________________________________________________________________________
####🍎 🤖 `INVALID_RECEIPT`
**Problem:**
