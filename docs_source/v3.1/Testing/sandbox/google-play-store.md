...
metadata: 
  ...
  image: 
    0: "https://files.readme.io/402eff1-OG_image.png"
    1: "OG image.png"
    2: 1200
    3: 627
    4: "#e9acb0"
createdAt: {}
updatedAt: "2021-06-01T20:48:50.273Z"
---
[block:callout]
{
  "type": "success",
...
In the sidebar, click on **Setup** > **License testing**.  Add here the account you are using in your real device (the account you are logged in with).
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2f58ad2-IMG_2209.jpg",
        "IMG_2209.jpg",
        2554,
        1686,
        "#fafbfb"
