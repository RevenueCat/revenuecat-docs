...
metadata: 
  ...
  image: 
    ...
    4: "#e9acb0"
createdAt: {}
updatedAt: "2021-10-18T22:45:51.715Z"
---
...
Copy and paste the credentials JSON that was downloaded in [step 2](https://docs.revenuecat.com/docs/creating-play-service-credentials#2e-create-and-download-the-public-key) into your RevenueCat app settings and we'll be ready to handle Google Play purchases!
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0af5cd2-Step_Credentials.png",
        "Step_Credentials.png",
        1792,
        610,
        "#fafafa"
      ],
      "caption": "This is in the settings of your RevenueCat app."
    }
  ]
}
[/block]
