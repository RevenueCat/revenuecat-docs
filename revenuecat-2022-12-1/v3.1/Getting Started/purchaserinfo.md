...
metadata: 
  ...
  image: 
    ...
    4: "#e9acb0"
createdAt: {}
updatedAt: "2021-07-22T13:54:05.917Z"
---
...
[/block]
RevenueCat can handle refunds across iOS, Android, and Stripe for both subscription and non-subscription products. As soon as RevenueCat detects a refund, the `purchaserInfo` will be updated to reflect the correct entitlement status - no action required on your part! If you have questions about refunds, take a look at our [help center article](https://community.revenuecat.com/general-questions-7/how-do-i-issue-a-refund-115) covering the topic.
[block:callout]
{
  "type": "info",
