...
metadata: 
  ...
  image: 
    0: "https://files.readme.io/8fe1a5c-OG_image.png"
    1: "OG image.png"
    2: 1200
    3: 627
    4: "#e9acb0"
createdAt: "2020-07-09T16:43:38.169Z"
updatedAt: "2021-10-15T16:04:29.379Z"
---
[block:callout]
{
  "type": "success",
...
While A/B testing is available on iOS only, offerings can contain products from other platforms. If you decide to make an offering current, make sure it works on all platforms supported by your app. You can use the [Offering Override](doc:offering-override) feature to help you test your dynamic paywall across platforms without changing the current offering for your whole app.
